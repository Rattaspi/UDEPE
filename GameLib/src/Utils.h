...
enum PacketType {WELCOME, NEWPLAYER, DISCONNECT, ACK, PING, ACKPING, ACKMOVE, SHOOT, GAMEOVER, GAMESTART, GOAL, MOVE, MOVEBALL, JOINGAME, JOINGAME_OK,JOINGAME_NO, CREATEGAME, UPDATEGAMELIST, LOGIN, LOGIN_OK, LOGIN_NO, REGISTER, REGISTER_OK, REGISTER_NO, MSG, READY, UPDATEROOM, EXITROOM,EXITROOM_OK, UNLOG, GAMEINFO};
